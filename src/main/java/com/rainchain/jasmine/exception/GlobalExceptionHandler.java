package com.rainchain.jasmine.exception;


import com.rainchain.jasmine.component.ResultData;
...
//    }
    ...
    public ResultData<String> noHandlerFoundException(NoHandlerFoundException noHandlerFoundException) {
